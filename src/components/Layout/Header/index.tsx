  ...
  return (
    <div className="navbar mb-2 shadow-lg rounded-box relative container mx-auto bg-base-100">
            <div className="flex-1">
              ...
              <div className={`flex flex-col md:flex-row items-center absolute h-screen md:h-auto md:relative w-3/5 -translate-x-full duration-300 md:duration-0 md:translate-x-0 ${sidebar && 'translate-x-0'} md:w-auto z-10 top-0 left-0 bg-base-100 md:bg-base-100`}>
              ...
              <div className="dropdown dropdown-end">
                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                  <div className="w-10 rounded-full">
                    <img alt="hello" src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
                  </div>
                </div>
